import 'package:budget_app_2/components.dart';
import 'package:budget_app_2/models.dart';
  ...
  Future addExpense(BuildContext context) async {
    ...
    return await showDialog(
      ...
      builder: (BuildContext context) => AlertDialog(
        contentPadding: EdgeInsets.all(screenWidth < 600
            ? 16.0
            : 32.0), // Adjust padding for smaller screens
        ...
        title: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height:
                    10.0, // Decrease the vertical spacing between Name and Amount
              ),
              TextForm(
                text: "Amount",
    ...
    return await showDialog(
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        title: Form(
          ...
          child: Column(
            crossAxisAlignment:
                CrossAxisAlignment.start, // Change to a column layout
            children: [
              TextForm(
                text: "Name",
                containerWidth: screenWidth < 600 ? 100.0 : 130.0,
